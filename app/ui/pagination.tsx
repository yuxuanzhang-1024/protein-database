      ...
      <div className="inline-flex">
        ...
        <div className="flex -space-x-px">
          {allPages.map((page, index) => {
            ...
            // set page to '...' if it is an ellipsis 
...
function PaginationNumber({
  ...
  const className = clsx(
    'flex h-10 w-10 items-center justify-center text-sm border border-black text-black',
    {
...
function PaginationArrow({
  ...
  const className = clsx(
    'flex h-10 w-10 items-center justify-center rounded-md border border-black text-black',
    {
